        ...
        {showUpload && isPilot && (
          <div className="px-4 py-3 border-b border-border bg-muted/20">
            <p className="text-xs text-muted-foreground mb-2">
              Uploading to: <span className="text-foreground font-medium">
                {selectedFolderObj ? selectedFolderObj.name : 'Unfiled'}
              </span>
            </p>
            <DocumentUploadForm
              entityType="general"
              entityId={null}
              folderId={selectedFolderObj ? selectedFolder : null}
          ...
          {!selectedFolder && (
            <div className="flex flex-col items-center justify-center h-full text-center p-8">
              ...
              <p className="text-sm text-muted-foreground max-w-md">
                Select a folder from the sidebar to view its documents, or click Upload to add
                a document. Use folders to organize certifications, insurance documents,
                FAA authorizations, forms, maintenance records, and more.
              </p>
            </div>
          )}
          ...
          {selectedFolder && !docsLoading && filteredDocs.length === 0 && (
            <div className="flex flex-col items-center justify-center h-full text-center p-8">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Click Upload above to add a document to this folder.
              </p>
            </div>
          )}
          {selectedFolder && !docsLoading && filteredDocs.length > 0 && (
