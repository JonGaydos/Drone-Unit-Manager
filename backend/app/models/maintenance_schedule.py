...
class MaintenanceSchedule(Base):
    ...
    entity_type: Mapped[str] = mapped_column(String(50))  # vehicle, battery, controller, dock, sensor, attachment, organization, other
    entity_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)  # null for org-wide
    frequency: Mapped[str] = mapped_column(String(20))  # monthly, quarterly, yearly, two_years, three_years, one_time
