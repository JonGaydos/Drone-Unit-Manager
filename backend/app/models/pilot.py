...
from sqlalchemy import String, Text, DateTime, ForeignKey, Integer, Boolean, func, text
...
class Pilot(Base):
    ...
    # Separate from status. A pilot who leaves the unit goes inactive but their
    # flights are still the unit's activity; a vendor or guest operator's never
    # were, however live their account is.
