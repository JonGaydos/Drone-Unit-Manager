...
# Permitted parent entity types for document attachment. Anything outside
# this set would let a client steer the upload path to an unintended
# directory. "general" is for standalone documents (forms, authorizations)
# uploaded from the Documents page with no parent entity.
ALLOWED_ENTITY_TYPES = {
    "pilot", "vehicle", "certification",
    "battery", "controller", "dock", "sensor", "attachment", "other",
...
async def upload_document(
    ...
    """Upload a document, optionally attached to a parent entity.

    Args:
        file: The uploaded file.
        entity_type: Parent entity type (see ALLOWED_ENTITY_TYPES); "general"
            for standalone documents with no parent entity.
        entity_id: ID of the parent entity (required unless entity_type is
            "general").
    ...
    """
    # Strip any directory components from the client-supplied filename. A
